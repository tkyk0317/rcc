...
test "main() { i = 0; while (1) { i = i + 1; if (i < 100) { continue; } else { break; } } i; }" 100 121
test "main() { i = 0; do { i = i + 1; if (i < 100) { continue; } else { break; } } while(1); i; }" 100 122
test "main() { i = 0; for (;; i = i + 1) { if (i < 100) { continue; } else { break; } } i; }" 100 123
